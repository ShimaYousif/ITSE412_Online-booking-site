                      ...
                      <div class="card-body">
                        ...
                        //$result = $connect->query($query);
                            ...
                            while ($row = mysqli_fetch_array($query))
                             ...
                             <form  method="post">
                              ...
                              if (isset($_POST['submit2'])) {
                               $sql2 = "UPDATE room  SET adults='".$_POST['adults']."',categorie='".$_POST['categories']."',bed_type='".$_POST['bed_type']."',price='".$_POST['price']."'
                              ,facilities='".$_POST['facilities']."',img='".$_POST['img']."'  WHERE `id_room`='".$_POST['id_room']."';";
                            ...
                            //$result = $connect->query($query);
                                ...
                                //eeror in the connection
                                if($query2)
                                echo "<script>alert('Update Room');</script>";
                            }
                                }
