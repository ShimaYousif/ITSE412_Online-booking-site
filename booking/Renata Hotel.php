  ...
  <div class="site-section bg-light">
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata1_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata2_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
                <h2 class="heading"> Superior Double Room With Sea View</h2>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata3_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
                <h2 class="heading">Comfort Room with Terrace</h2>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata4_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata5_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata6_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
                <h2 class="heading">Premier Room </h2>
                <div class="price"><sup>$</sup><span class="number">250</span><sub>/per night</sub></div>
                <ul class="specs">
                  <li><strong>Adults:</strong> 3</li>
                  <li><strong>Categories:</strong> Single</li>
                  <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                  <li><strong>Bed Type:</strong> 1double bed and 1 sofa bed</li>
                </ul>
                <p><a href="#" class="btn btn-primary px-4">Booke Now</a></p>
              </div>
            </div>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata7_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
                <h2 class="heading">Single Room</h2>
                <div class="price"><sup>$</sup><span class="number">145</span><sub>/per night</sub></div>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src="images/renata8_img.jpg" alt="Image placeholder"></a>
              </div>
              <div class="text">
                <h2 class="heading">Family Room</h2>
                <div class="price"><sup>$</sup><span class="number">375</span><sub>/per night</sub></div>
