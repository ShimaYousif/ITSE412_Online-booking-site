    ...
    <div class="container">
     <div class="tab-pane fade show active" id="pills-hotel" role="tabpanel" aria-labelledby="pills-hotel-tab">
      <div class="row">
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.html" style="background-image: url('images/ehden_img1.jpg'); "></a>
            <div class="text">

              <h2 class="heading"><a href="#">The Ehden Hotel</a></h2>
              <p class="meta"><em></em> <a href="">Lebanon</a> <span class="sep">&bullet;</span> <em></em> <a href="#">Ehden</a> </p>
              <p>Ehden Hotel features views of the Cedar Mountains and the Qazhia Valley, a 60-minute drive from Beirut. It features an outdoor pool, gym and tennis courts. Wi-Fi is available upon request.</p>
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.html" style="background-image: url('images/hw_img1.jpg'); "></a>
            <div class="text">
              <h2 class="heading"><a href="#">The WH Hotel</a></h2>
              <p class="meta"><em></em> <a href="">Lebanon</a> <span class="sep">&bullet;</span> <em></em> <a href="#"> Beirut</a> </p>
              <p>Located on Hamra Street, 20 minutes from central Beirut, WH offers modern rooms and suites with balcony and free Wi-Fi. Each room has a seating area with a flat-screen TV and a minibar. The kitchenette includes a stove and an electric kettle. Beirut International Airport is a 10-minute drive from the hotel and an airport shuttle service is available on request. </p>
              <div class="media block-6">
              <div class="icon"><span class="flaticon-double-bed"></span></div>
              <div class="media-body">
                <h3 class="heading">Luxury Rooms</h3>
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            ...
            <div class="text">
              <h2 class="heading"><a href="#">The Byblos sur Mer Hotel</a></h2>
              <p class="meta"><em></em> <a href="">Lebanon</a> <span class="sep">&bullet;</span> <em></em> <a href="#"> Byblos</a> </p>
              <p>Overlooking the Old Port in Byblos, this boutique hotel features a private beach deck with an intimate covered area for dining. It offers free Wi-Fi. All rooms at Byblos Sur Mer are decorated with mahogany furniture and oriental carpets. All rooms feature comfortable natural lighting and a flat-screen TV with satellite channels. Rooms feature great sea views and some rooms have a balcony. Dar Azrak Restaurant serves seafood and typical Mediterranean dishes. In the evening, guests can enjoy a drink at the Tournesol Café. </p>
              <div class="media block-6">
              <div class="icon"><span class="flaticon-double-bed"></span></div>
              <div class="media-body">
                <h3 class="heading">Luxury Rooms</h3>
